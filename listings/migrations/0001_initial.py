    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('Owned', 'Owned')], default='For Sale', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('building_type', models.CharField(choices=[('House', 'House'), ('Appartment Complex', 'Apt'), ('Industrial', 'Indust')], default='Industrial', max_length=50)),
