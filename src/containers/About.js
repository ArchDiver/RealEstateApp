...
import satMap from '../assets/images/satmap.jpg'
    ...
    return (
        <main className='about'>
            ...
            <header className='about__header'>
                <h1 className='about__heading'>About EnergyHawk</h1>
            </header>
            <section className='about__info'>
                <div className='row'>
                    <div className='col-3-of-4'>
                        <h2 className='about__subheading'>Energy Solutions</h2>
                        ...
                        <div className='about__display'>
                            <img className='about__display__image' src={satMap} alt='' />
                        </div>
                        <p className='about__paragraph'>
