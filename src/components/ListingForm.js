...
const ListingForm = (props) => {
    ...
    const { sale_type, price, bedrooms, building_type, kWh, bathrooms, sqft, days_listed, has_photos, open_house, keywords } = formData;
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        axios.post(`${process.env.REACT_APP_API_URL}/api/listings/search`, { sale_type, price, kWh, bedrooms, building_type, bathrooms, sqft, days_listed, has_photos, open_house, keywords }, config)
        .then(res => {
            setLoading(false);
    ...
    return (
        <form className='listingform' onSubmit={e => onSubmit(e)}>
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        <label className='listingform__label' htmlFor='price'>kWh</label>
                        <select className='listingform__select' name='price' onChange={e => onChange(e)} value={kWh}>
                            <option>0+</option>
                            <option>200,000+</option>
                            <option>400,000+</option>
                            <option>600,000+</option>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        <label className='listingform__label' htmlFor='building_type'>building Type</label>
                        <select className='listingform__select' name='building_type' onChange={e => onChange(e)} value={building_type}>
                            <option>House</option>
